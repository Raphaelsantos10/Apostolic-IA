...
required_files=(
  ...
  "supabase/migrations/20260725110000_course_catalog.sql"
  ...
  "docs/sprints/SPRINT_018.md"
  "docs/development/LEARNING_CORE.md"
  "supabase/migrations/20260727120000_learning_core.sql"
  "supabase/tests/database/learning-core.test.sql"
  ...
  "docs/validation/SPRINT_010_VALIDATION.md"
  "docs/backups/SPRINT_010_BACKUP_MANIFEST.md"
